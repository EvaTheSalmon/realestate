...
-- Дата скрипта: 16.05.2016 21:17:56
...
('Алексей ', 'Гаврилов ', 'Аркадьевич ', 0, '2147483647', 'jftf@b-d-un.com', 1, '6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b', '84685690882', '20817951010594294b15a08cb86b015493f5857df2852744c85c763495576e81', 7),
...
(2, 64, 17, 'Лазурная Обь', 9267464.00, 2, 5, 2, '2013-07-31 00:00:00', 'На территории есть сад с плодовыми деревьями, небольшой дом (можно спокойно заезжать и жить). Все коммуникации, полный пакет документов. Участок находится возле асфальтированной дороги', 86, 395, 14, 1, NULL, 0),
(3, 45, 59, 'Солнечная горка', 7116014.00, 3, 2, 1, '2010-02-03 00:00:00', 'На участке трехэтажный дачный дом, который представляет собой: первый уровень - кухня, кладовая, подсобное посещение; второй уровень - три комнаты, баня, санузел; третий уровень - мансарда', 80, 593, 7, 1, NULL, 0),
(4, 34, 94, 'Кедровая опушка', 1705489.00, 4, 3, 1, '2011-03-14 00:00:00', 'Дом с мансардой, также на участке расположен гостевой домик. с/т Охотник, з,у 5 соток. Тихое спокойное место, отлично подходит, как для отдыха так и для жизни. Коммуникации: свет, вода, канализация-септик, газ проводят', 43, 191, 7, 1, NULL, 0),
(5, 57, 91, 'Усадьба на Лесной', 1223322.00, 5, 4, 1, '2010-10-05 00:00:00', 'Очень симпатичный дом с хорошим садом, теплицами, зоной отдыха, живописным видом. Дом состоит из 3-х комнат, кухни, сан.узла, гаража. Рядом остановка городского транспорта', 75, 121, 12, 1, NULL, 0),
(6, 97, 46, 'Тихий уголок', 7293265.00, 6, 4, 2, '2014-11-07 00:00:00', 'Дом в микрорайоне Мамайка, в садовом товариществе, в пешей доступности от моря. Первый этаж жилой, участок ухоженный, двор с паркингом .Есть возможность выкупить соседний участок 2 сотки', 46, 16, 18, 1, NULL, 0),
(7, 14, 57, 'Кедровый край', 8244432.00, 7, 5, 2, '2012-09-17 00:00:00', 'Дом в окружении природы,чистый воздух,отличные соседи,капитальный дом,который можно завершить по своему вкусу!', 6, 321, 3, 1, NULL, 0),
